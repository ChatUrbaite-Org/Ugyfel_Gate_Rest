...
public class ID_CARD
{
    ...
    public ID_CARD(int CAN_number, User user, Organisation organ, String id_num, boolean finger_print, Date from, Nationality nation) {
    ...
    public ID_CARD(int id, int CAN_number, User user, Organisation organ, String id_num, boolean finger_print, Date from, Nationality nation) {
        this.id = id;
        this.CAN_number = CAN_number;
        this.user = user;
        this.organ = organ;
